...
function Nav({ currentPage, setCurrentPage }) {
  ...
  const links = [
    ...
    { id: "experts", label: "Trouver un MDM" },
    { id: "register", label: "Offrir des services" },
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 48, marginBottom: 48 }}>
          ...
          <div>
            ...
            {["Trouver un MDM", "Offrir des services", "Tarification", "FAQ"].map(t => (
          ...
          <div>
            ...
            <p style={{ color: "#64748b", fontSize: 14, marginBottom: 10 }}>contact@mow-on-demand.com</p>
            <p style={{ color: "#64748b", fontSize: 14 }}>Casablanca, Maroc</p>
          </div>
        </div>
  ...
  return (
    <div>
      ...
      <section style={{
        ...
        <div style={{ display: "flex", gap: 16, justifyContent: "center" }}>
          <button onClick={() => setCurrentPage("experts")} style={{ background: "linear-gradient(135deg, #2dd4bf, #0d9488)", border: "none", color: "#0a192f", padding: "16px 36px", borderRadius: 12, cursor: "pointer", fontFamily: "'DM Sans', sans-serif", fontSize: 16, fontWeight: 700 }}>Je cherche un MDM</button>
          <button onClick={() => setCurrentPage("register")} style={{ background: "transparent", border: "1px solid rgba(45,212,191,0.4)", color: "#2dd4bf", padding: "16px 36px", borderRadius: 12, cursor: "pointer", fontFamily: "'DM Sans', sans-serif", fontSize: 16, fontWeight: 600 }}>Offrir des services</button>
        </div>
      </section>
    </div>
  );
  ...
  return (
    <div style={{ background: "#0a192f", minHeight: "100vh", paddingTop: 100, paddingBottom: 80 }}>
      <div style={{ maxWidth: 700, margin: "0 auto", padding: "0 24px" }}>
        <SectionTitle tag="OFFRIR DES SERVICES" title="Rejoignez la communauté" subtitle="Partagez votre expertise avec les entrepreneurs et managers au Maroc" />
    ...
    <div style={{ background: "#0a192f", minHeight: "100vh", paddingTop: 100, paddingBottom: 80 }}>
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 24px" }}>
        ...
        <div style={{
          ...
          <p style={{ color: "#94a3b8", fontSize: 16, lineHeight: 1.8, marginBottom: 24 }}>
            MOW Connect est une initiative conçue par le Professeur Hamid Bouchikhi, expert en management et entrepreneuriat.
          </p>
          <div style={{ display: "flex", gap: 24, alignItems: "center", background: "rgba(45,212,191,0.04)", borderRadius: 16, padding: 28 }}>
            ...
            <div>
              ...
              <div style={{ color: "#2dd4bf", fontSize: 14, fontWeight: 600, marginBottom: 8 }}>Fondateur</div>
              <div style={{ color: "#94a3b8", fontSize: 14, lineHeight: 1.7 }}>Professeur de Management & Entrepreneuriat. Auteur de publications académiques et d'ouvrages sur l'identité organisationnelle et l'entrepreneuriat.</div>
            </div>
          </div>
        </div>
